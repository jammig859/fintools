/**
 * Forked from initial Jovan Popovic plugin for column Filter
 * This Forked corrects the incompatibility between the last DataTables version (1.10.x) and the plugin.
 *
 */
/*
